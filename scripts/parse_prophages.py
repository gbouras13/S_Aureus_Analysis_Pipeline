...
def parse_prophages(input_fasta, out_dir, output_touch, sample):    
...
parse_prophages(snakemake.input[0],snakemake.params[0], snakemake.output[0], snakemake.wildcards.sample)
